...
<xsl:stylesheet xmlns:bk="http://gams.uni-graz.at/rem/bookkeeping/" xmlns:r="http://gams.uni-graz.at/rem/ns/1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"    xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="xs" version="2.0">
  <xd:doc>
  ...
  <xd:doc><xd:desc><xd:p>transform classical currency units (e.g. pound, shilling etc.) into basic unit</xd:p>
    <xd:p><xd:b>ToDo</xd:b> Should be based on an external ontology</xd:p></xd:desc></xd:doc>
  ...
  <xd:doc><xd:desc>Converts a value in penny into pound/shilling/penny ("short shilling")</xd:desc></xd:doc>
  ...
  <xsl:template name="zahlen">
    ...
    <xd:doc><xd:desc>deprecated! everything should already be done in the bk:roman2int functions</xd:desc></xd:doc>
  ...
  <xsl:function as="xs:decimal" name="bk:roman2int-ext">
    ...
    <xd:doc><xd:desc>converts roman numbers into numerical values considering r:sup/r:exp as an exponent</xd:desc></xd:doc>
    <xsl:choose>
  ...
  <xd:doc><xd:desc>Converts roman numbers into numerical values, using &#x0336; for half values. Based heavily on James Cummings work at https://github.com/jamescummings/conluvies/blob/master/xslt-misc/romanMoney2TEI.xsl</xd:desc></xd:doc>
